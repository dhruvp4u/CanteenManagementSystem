<%-- 
    Document   : order
    Created on : Apr 1, 2016, 2:33:59 AM
    Author     : Dhruv
--%>
...
<section id="container" class="sub-page">
	<div class="wrap-container zerogrid">
		...
		<div id="main-content">
                    <h1 style="margin-left:35px;"> Click on food to order </h1>
					...
					<div class="col-1-3">
						<div class="wrap-col">
							<h3>Present Orders</h3>
                                                        ...
                                                        rs1 = st1.executeQuery("select * from menu,active_order,student_details where menu.m_id=active_order.m_id and active_order.s_id=student_details.s_id ");
                                                        %>
                                                        <%  while(rs1.next()){ %>
							<div class="post">
								<a href="#"><img src="../Admin/images/menu_pics/<%= rs1.getString("picture_path")%>"/></a>
								<div class="wrapper">
								  <h5><a href=""><%= rs1.getString("name")%></a></h5>
                                                                  <h5><a href=""><%= rs1.getString("student_details.name")%></a></h5>
								  <span>Rs.<%= rs1.getString("price")%></span>
                                                                  <span>Delivery Room No.-<%= rs1.getString("room_no")%></span>
                                                                  
								</div>
							</div>
                                                                  <span> <a href="complete_order.jsp?a_id=<%= rs1.getString("a_id")%>">Order Complete </a> </span>
                                                        <% } %>
						</div>
                                        </div>
				</div>
