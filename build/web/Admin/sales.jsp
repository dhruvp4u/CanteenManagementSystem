<%-- 
    Document   : sales
    Created on : Apr 1, 2016, 4:03:39 AM
    Author     : Dhruv
--%>
					...
					<div class="col-1-3">
						<div class="wrap-col">
							<h3></h3>
                                                        ...
                                                        rs1 = st1.executeQuery("select * from menu,past_order,student_details where menu.m_id=past_order.m_id and past_order.s_id=student_details.s_id ");
                                                        %>
                                                        <%! int paisa; %>
                                                        <%  while(rs1.next()){  
							...
							<div class="post">
								...
								<div class="wrapper">
								  <h3><a href="">We have to earned Rs. <%= paisa %> till today on Food.</a></h3>
