					...
					<div class="col-1-3">
						<div class="wrap-col">
							<h3>Feedback</h3>
                                                        ...
                                                        rs1 = st1.executeQuery("select * from feedback ");
                                                        %>
                                                        <%  while(rs1.next()){ %>
							<div class="post">
								
								<div class="wrapper">
								  <h2><a href="">Name : <%= rs1.getString("name")%></a></h2>
                                                                   <h5><a href="">Food Rating : <%= rs1.getString("food_rating")%> Star</a></h5>
                                                                  <h5><a href="">Service : <%= rs1.getString("service")%></a></h5>
								  <span>Comment : <%= rs1.getString("comment")%></span>
