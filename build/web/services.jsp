<%-- 
    Document   : services
    Created on : Mar 27, 2016, 12:17:18 AM
    Author     : Dhruv
--%>
	...
	<div class="wrap-container zerogrid">
		<div class="crumbs">
			<ul>
				...
				<li><a href="reservation.jsp">Bookings</a></li>
			</ul>
		</div>
		<div id="main-content">
			<div class="wrap-content">
				<div class="row">
					<div class="col-1-3">
						<div class="wrap-col">
							<h3>Book The Canteen For Festives</h3>
							<p>Book the canteen or caters for the festivals or events in the college.</p><br/>
							<h3>Or Just Make a Call</h3>
							<p>+91-8080808080 <br>
								+91-8181818181</p>
							<p>canteen@somaiya.edu</p>
						</div>
					</div>
					<div class="col-2-3">
						<div class="wrap-col">
								...
								<div id="contact_form">
									<form name="contact" id="contact" method="post" action="#">
										...
										<label class="row">
											<div class="col-2-4">
												<div class="wrap-col">
												<input type="text" name="event" id="subject" placeholder="Event Name" required="required" />
												</div>
											</div>
											<div class="col-1-4">
												<div class="wrap-col">
										...
										<label class="row">
											<div class="wrap-col">
												<textarea name="description" id="message" class="form-control" rows="4" cols="25" required="required"
