<%-- 
    Document   : curent_orders
    Created on : Mar 31, 2016, 2:36:36 PM
    Author     : Dhruv
--%>
					...
					<div class="col-1-3">
						<div class="wrap-col">
							<h3>Present Orders</h3>
                                                        ...
                                                        rs1 = st1.executeQuery("select * from menu,active_order,student_details where menu.m_id=active_order.m_id and active_order.s_id=student_details.s_id and student_details.s_id='"+ s_id +"' ");
                                                        %>
                                                        <%  while(rs1.next()){ %>
							<div class="post">
