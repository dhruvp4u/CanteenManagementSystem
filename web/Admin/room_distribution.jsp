<%-- 
    Document   : room_distribution
    Created on : Mar 31, 2016, 1:12:34 PM
    Author     : Dhruv
--%>
					...
					<div class="col-1-3">
						...
						<div class="wrap-col">
							<h3>Layout</h3>
                                                        ...
                                                        rs1 = st1.executeQuery("select * from college_layout");
                                                        %>
                                                        <%  while(rs1.next()){ %>
                                                        <div class="post">
								
								<div class="wrapper">
								  <h5><a href="#">Local host (testing)</a></h5>
								  <span>IP - 0.0.0.0.1</span>
								</div>
							</div>
							<div class="post">
								
								<div class="wrapper">
								  <h5><a href="#">Room No. <%= rs1.getString("room_no")%></a></h5>
								  <span>IP - 192.168.<%= rs1.getString("floor")%>.<%= rs1.getString("starting_ip")%> to 192.168.<%= rs1.getString("floor")%>.<%= rs1.getString("ending_ip")%></span>
								</div>
							</div>
