<%-- 
    Document   : bill
    Created on : Mar 31, 2016, 6:34:54 PM
    Author     : Dhruv
--%>
...
<section id="container" class="sub-page">
	<div class="wrap-container zerogrid">
		...
		<div id="main-content">
                    <h1 style="margin-left:35px;"> Bill And Your Current Location </h1>
					...
					<div class="col-1-3">
						<div class="wrap-col">
							...
							<div class="post">
								...
								<div class="wrapper">
								  <h3><a href="">You have to pay Rs. <%= paisa %> for your present order.</a></h3>
								 <% String local_host = "0:0:0:0:0:0:0:1";
                                                                  String ip =request.getRemoteAddr() ;
                                                                  //out.print(local_host);
                                                                  if(ip.equals(local_host))
                                                                  {%>
                                                                    <span>You Are Testing this On local host</span>
