<%-- 
    Document   : menu
    Created on : Mar 27, 2016, 12:16:40 AM
    Author     : Dhruv
--%>
		...
		<div id="main-content">
			...
			<div class="wrap-content">
                        ...
                        <% 
                                                ...
                                                ResultSet rs;
                                                rs = st.executeQuery("select * from menu_catagories");
					...
					<div class="col-1-3">
						<div class="wrap-col">
							<h3><%= rs.getString("name")%></h3>
                                                        ...
                                                        rs1 = st1.executeQuery("select * from menu where c_id='"+ c_id +"' ");
                                                        %>
                                                        <%  while(rs1.next()){ %>
							<div class="post">
								<a href="order.jsp?menu_id=<%= rs1.getString("m_id")%>"><img src="../Admin/images/menu_pics/<%= rs1.getString("picture_path")%>"/></a>
								<div class="wrapper">
								  <h5><a href="order.jsp?menu_id=<%= rs1.getString("m_id")%>"><%= rs1.getString("name")%></a></h5>
